...
urlpatterns = [
    path('cost/', views.get_cost_and_usage_for_current_month,
         name='get all demensions'),
    path('past-cost/', views.get_cost_and_usage_for_past_six_months,
         name='get all demensions'),
    ...
    path('get-tags/', views.db_get_all_tags, name='get all demensions'),
]
